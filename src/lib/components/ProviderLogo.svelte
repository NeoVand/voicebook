<script lang="ts">
	...
	let { provider, size = 16 }: { provider: CloudLlmProvider; size?: number } = $props();
</script>
...
<style>
	...
	/* The OpenAI mark ships cream for dark surfaces; every theme declares its
	 * color-scheme, so light themes flip it to a dark ink. */
	.openai {
		fill: light-dark(#3a352e, #ede3d3);
	}
</style>
